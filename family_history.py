...
def print_marriages(marriages_dict, people_dict):
    ...
    for _ in marriages_dict:
        info_two = marriages_dict[_]
        names = info_two[0]
        names_two = info_two[1]
        info = people_dict[names]
        infos = people_dict[names_two]
        name_one = info[0]
        name_two = infos[0]
        birth = info[2]
        birth_two = infos[2]
        year_of_marriage = info_two[2]
        age_at_marriage = year_of_marriage - birth
        age_at_marriage_two = year_of_marriage - birth_two
        print(name_one, age_at_marriage, "married:", year_of_marriage, name_two, age_at_marriage_two)
