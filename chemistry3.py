def main():
    ...
    mole = input("Enter the molecular formula of the sample: ")
    ...
    parse_formula(mole, periodic_table['symbol'])

    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    compute_molar_mass(mass, periodic_table)
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    molar_mass = symbol_quantity_list[0] * symbol_quantity_list[1] + symbol_quantity_list[0] * symbol_quantity_list[1]
    print(molar_mass)
